...
PsycoRally.Stages.Intro = function(oncomplete) {
    ...
    this.load = function() {
        ...
        this.dom.credits = new Element('p.credits').set('html', 'a game by <a href="http://abidibo.net">abidibo</a>').setStyle('left', '250%');
        ...
        this.dom.container.adopt(this.dom.title, this.dom.credits, this.dom.content).inject(document.body);
        setTimeout(function() { 
            self.dom.title.setStyle('left', 0); 
            self.dom.credits.setStyle('left', '50px'); 
        }, 500);
        setTimeout(function() { 
...
PsycoRally.Stages.ChooseName = function(oncomplete) {
    ...
    this.load = function() {
        ...
        var submit = new Element('a.fa.fa-4x.fa-arrow-circle-right.button')
            ...
            var table = new Element('table.specifications').adopt(
                ...
                new Element('tr')
                    .adopt(
                        ...
                        new Element('th').set('text', 'grass')
                    ),
                new Element('tr.speed')
                    .adopt(
                        new Element('td').set('text', 'speed'),
                        new Element('td').adopt(new Element('div.scale').adopt(new Element('div').setStyle('width', specifications.velocity.road + 'px'))),
                        new Element('td').adopt(new Element('div.scale').adopt(new Element('div').setStyle('width', specifications.velocity.grass + 'px')))
                    ),
                new Element('tr.acceleration')
                    .adopt(
                        new Element('td').set('text', 'accel'),
                        new Element('td').adopt(new Element('div.scale').adopt(new Element('div').setStyle('width', specifications.acceleration.road + 'px'))),
                        new Element('td').adopt(new Element('div.scale').adopt(new Element('div').setStyle('width', specifications.acceleration.grass + 'px')))
                    ),
                new Element('tr.steering')
                    .adopt(
                        new Element('td').set('text', 'steering'),
                        new Element('td').adopt(new Element('div.scale').adopt(new Element('div').setStyle('width', specifications.steering.road + 'px'))),
                        new Element('td').adopt(new Element('div.scale').adopt(new Element('div').setStyle('width', specifications.steering.grass + 'px')))
                    )
            );
